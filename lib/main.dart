...
class MyApp extends StatelessWidget {
  ...
  static const String _title = 'Tabla Periódica de los Elementos';
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  Future<void> loadJsonData() async {
    var jsonText = await rootBundle.loadString('assets/data/elementos.json');
    data = json.decode(jsonText)["elements"].cast<List<dynamic>>();
  }
  ...
  static goToWebsite(String url) async {
  ...
  final List<Widget> _widgetOptions = <Widget>[
        ...
        itemBuilder: (context, index) {
          return Card(
            child: Column(
              ...
              children: [
                Text("Elemento: " + data[index]['name'].toString(),
                    textAlign: TextAlign.center, style: const TextStyle(fontWeight: FontWeight.bold)),
                Text("Densidad: " + data[index]['density'].toString(),
                    textAlign: TextAlign.center, style: const TextStyle(fontWeight: FontWeight.bold)),
                Text("Estado: " + data[index]['phase'].toString(),
                    textAlign: TextAlign.center, style: const TextStyle(fontWeight: FontWeight.bold)),
                Text("Simbolo: " + data[index]['symbol'].toString(), style: const TextStyle(fontWeight: FontWeight.bold),
                    textAlign: TextAlign.center),
                const Text(""),
                ElevatedButton(
                  onPressed: () => goToWebsite(data[index]['source']),
    ...
    Column(
      ...
      children: [
        ...
        const Text("Jacsel Guridi Diaz",
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
        const Text("2019-8282",
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20))
      ],
    )
  ];
